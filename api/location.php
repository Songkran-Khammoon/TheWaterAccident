...
switch ($case) {
    ...
    case 1: //Insert data
        ...
        $sql = "INSERT INTO location(id,img, namelocation, locationLat, locationLng, typeriskID, equipPlace, equipLat, equipLng, practiceArea, howtoUse, void) VALUES(null,:img1, :namelocation, :locationLat, :locationLng, :typeriskID, :img2, :equipLat, :equipLng, :practiceArea, :img3,0)";
        $stmt = $conn->prepare($sql);
    ...
    case 2: //Update data 
        $target_dir = "img/";
        $sql = "UPDATE location SET namelocation = :namelocation, locationLat = :locationLat, locationLng = :locationLng, typeriskID = :typeriskID, equipLat = :equipLat, equipLng = :equipLng, practiceArea = :practiceArea ";
        // img1
        if ($_FILES["img1"] != null) {
            $sql .= ", img = :img1";
            $target_file1 = $target_dir . uniqid() . basename($_FILES["img1"]["name"]);
